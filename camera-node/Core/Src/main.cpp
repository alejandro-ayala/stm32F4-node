...
void createHardwareAbstractionLayerComponents()
{
	...
	CameraCfg cameraCfg{hdcmi, hdma_dcmi, hi2c2};
...
//  osThreadDef(readSensorsTask, readSensors, osPriorityNormal, 0, 128);
//  readSensorsHandle = osThreadCreate(osThread(readSensorsTask), imuControl);
//
//  osThreadDef(sendDataTask, sendData, osPriorityNormal, 0, 128);
//  sendDataHandle = osThreadCreate(osThread(readSensorsTask), commMng);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_10|GPIO_PIN_12|GPIO_PIN_13|GPIO_PIN_14
                          |CAMERA_RESET_Pin, GPIO_PIN_RESET);
