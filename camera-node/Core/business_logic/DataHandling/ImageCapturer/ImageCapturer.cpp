...
std::array<std::array<uint8_t, imgWidth>, imgHeight> ImageCapturer::arrangeBuffer(const unsigned char *image)
{

    std::array<std::array<uint8_t, imgWidth>, imgHeight> rawImage;
